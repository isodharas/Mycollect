...
const T: Record<Lang, Record<string, string>> = {
  ...
  si: {
    overview: 'දළ විශ්ලේෂණය', live_bins: 'සජීව බදුන් ', routes: 'මාර්ග',
    ...
    waste_intelligence: 'අපද්‍රව්‍ය පිලිබඳ කෘත්‍රිම බුද්ධිය', municipal_operator: 'නාගරික ක්‍රියාකරු',
    total_bins: 'මුළු බදුන්', critical: 'අවදානම්', high_priority: 'ඉහළ ප්‍රමුඛතා',
    ...
    all_bins_status: 'සියලු බදුන් සජීව තත්ත්වය', view_all: 'සියල්ල බලන්න',
    ...
    bin_id: 'බදුන් හැඳුනුම', location: 'ස්ථානය', priority: 'ප්‍රමුඛතාව',
    add_new_bin: 'නව බදුන එකතු කරන්න', edit_bin: 'බදුන සංස්කරණය', delete_bin: 'මකන්න',
    save_changes: 'වෙනස්කම් සුරකින්න', cancel: 'අවලංගු කරන්න',
    search_bins: 'බදුන් හෝ ස්ථාන සොයන්න...',
    bins_monitored: 'බදුන් නිරීක්ෂණය', navigation: 'සංචලනය',
  }
}
