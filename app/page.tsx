    ...
    <div style={{fontFamily:'Poppins, sans-serif',color:'#0F1F18',overflowX:'hidden'}}>
      ...
      <div className="ticker-wrap">
        <div className="ticker-inner">
          {['95.94% ML Accuracy','446ms Response Time','Health-First Waste Intelligence','SDG 3 · Good Health','SDG 11 · Sustainable Cities','Random Forest · 100 Trees','12 Bins · Homagama Zone','17% Fuel Reduction','AWS Lambda · ap-southeast-2','70% Weight on Gas PPM',
            '95.94% ML Accuracy','446ms Response Time','Health-First Waste Intelligence','SDG 3 · Good Health','SDG 11 · Sustainable Cities','Random Forest · 100 Trees','12 Bins · Homagama Zone','17% Fuel Reduction','AWS Lambda · ap-southeast-2','70% Weight on Gas PPM',
          ].map((t,i)=>(
